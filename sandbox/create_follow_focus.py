...
if sel_nodes:
    ...
    rename_distance = cmds.rename("distanceDimension1",
    ...
    cmds.setAttr(
        rename_locator1 + '.tx', lock=True, keyable=False, channelBox=False)
    cmds.setAttr(
        rename_locator1 + '.ty', lock=True, keyable=False, channelBox=False)
    cmds.setAttr(
        rename_locator1 + '.tz', lock=True, keyable=False, channelBox=False)
    cmds.setAttr(
        rename_locator1 + '.rx', lock=True, keyable=False, channelBox=False)
    cmds.setAttr(
        rename_locator1 + '.ry', lock=True, keyable=False, channelBox=False)
    cmds.setAttr(
        rename_locator1 + '.rz', lock=True, keyable=False, channelBox=False)
